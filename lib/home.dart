...
import 'package:t24/constants.dart';
import 'package:t24/res_card.dart';
import 'package:t24/res_card1.dart';
import 'package:t24/res_view.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
          ...
          textTheme: TextTheme(
            headline: TextStyle(fontWeight: FontWeight.bold, fontStyle: FontStyle.italic,fontFamily: "Oxygen",fontSize: 29),
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text("Where would you\n like to eat", style:TextStyle(fontSize: 29, fontStyle: FontStyle.italic,fontFamily: "Oxygen", fontWeight: FontWeight.w800
            )),
...
class DataSearch extends SearchDelegate<String>{
    ...
    return FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot){
          ...
          if(snapshot.hasData){
            ...
            return ListView.builder(itemCount: snap1.length,itemBuilder: (context, index){
              return resCard1('${snap1[index]['resName']}','${snap1[index]['image']}');
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return ListView.builder(itemCount: searchList.length,itemBuilder: (context, i ){
      return ListTile(leading: Icon(Icons.mobile_screen_share),
